...
import org.julio.gregorio.adidas.email.api.EmailController;
//import org.julio.gregorio.adidas.email.api.JwtAuthenticationController;
...
public class SwaggerConfiguration {
	...
	public Docket ordersDocket() {
		...
		return new Docket(DocumentationType.SWAGGER_2).groupName(groupName).pathMapping("/").apiInfo(apiInfo)
				...
				.apis(includeOnly(EmailController.class 
